...
int main(int argc, char* argv[])
{
	...
	else if (strcmp(argv[2], EXT_CMD_2) == 0) {
		if (argc != 3) {
	...
	else if (strcmp(argv[2], EXT_CMD_3) == 0) {
		if (argc != 5) {
			fprintf(stderr, "Numero parametri inatteso\n");
			return -5;
		}
		ioctl_mauval.variable_a = atoi(argv[3]);
		ioctl_mauval.variable_b = atoi(argv[4]);
